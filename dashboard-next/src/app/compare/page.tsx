...
const fleetData = [
  { name: "Waymo (미국)", vehicles: 700, color: "#3b82f6" },
  { name: "Baidu Apollo (중국)", vehicles: 500, color: "#ef4444" },
  { name: "Pony.ai (중국)", vehicles: 250, color: "#f97316" },
  { name: "카카오모빌리티 (한국)", vehicles: 30, color: "#8b5cf6" },
  { name: "42dot (한국)", vehicles: 10, color: "#06b6d4" },
];

const readinessData = [
  { subject: "법/규제", 한국: 60, 미국: 85, 중국: 75 },
  { subject: "인프라", 한국: 70, 미국: 90, 중국: 80 },
  { subject: "기술 수준", 한국: 55, 미국: 95, 중국: 85 },
  { subject: "시장 규모", 한국: 40, 미국: 95, 중국: 90 },
  { subject: "보험/책임", 한국: 50, 미국: 70, 중국: 60 },
  { subject: "대중 수용도", 한국: 65, 미국: 60, 중국: 70 },
];

const milestoneData = [
  { country: "미국", year: 2018, event: "Waymo One 상용 서비스 시작" },
  { country: "중국", year: 2020, event: "Baidu Apollo 베이징 시범운행" },
  { country: "한국", year: 2022, event: "상암 DMC 시범운행지구 지정" },
  { country: "미국", year: 2023, event: "Cruise SF 무인운행 허가 (후 중단)" },
  { country: "한국", year: 2023, event: "카카오모빌리티 유상 로보택시 출시" },
  { country: "중국", year: 2024, event: "우한 전역 무인택시 허가" },
  { country: "한국", year: 2026, event: "로보택시 상용화 1단계 목표 (예정)" },
];
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <p className="text-xs text-gray-400 mt-2">* 공개 자료 기반 추정치. 실제 운행 차량 수와 다를 수 있음.</p>
      </section>
